...
def main():
    while True:
        ...
        print("4. Convert a video to audio (YouTube or local)")
        print("5. Convert a full playlist to audio")
        print("6. Exit")
        ...
        if choice == "1":
            ...
            source = input("Enter 'youtube' to convert a YouTube video or 'local' to convert a local video: ").lower()
            if source == "youtube":
                url = input("Enter the YouTube video URL: ")
                filename = download_video(url)
                if filename:
                ...
                print("Invalid choice. Please enter 'youtube' or 'local'.")
